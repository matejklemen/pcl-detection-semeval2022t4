...
from src.models.utils import NER_TAGS, bracketed_representation, optimize_threshold
...
if __name__ == "__main__":
    ...
    if args.optimize_decision == "after_training":
        del model
        model = NERRobertaForSequenceClassification.from_pretrained(args.experiment_dir, return_dict=True).to(DEVICE)
